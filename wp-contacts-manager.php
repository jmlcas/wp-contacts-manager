<?php
/**
 *   Plugin Name: WP Contacts Manager
 *   Plugin URI: https://labarta.es/wp-contacts-manager-free-plugin-wordpress/
 *   Description: WP Contacts Manager is a WordPress Plugin for manage unlimited contacts, all from the WP dashboard. WP Contacts Manager is a CRUD: Create, Read, Update and Delete. 
 *   Version: 2.2.1
 *   Author: Labarta
